...
// i10.add(i3);
    ...
    function generate(){
        ...
        for(let i = 0; i < maxLN; i++){
            ...
            if(Math.random() >= 0.5 || maxLN-1 === i){
                if( Math.random() < 0.4 || maxLN-1 === i){
                    genText += ":";
                    start = true;
                }
            }
